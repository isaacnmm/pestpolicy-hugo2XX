...
1.  **Exhaust Fan:** Sized correctly for your bathroom (CFM).
2.  **Ductwork:**
...
3.  **Duct Connectors/Clamps:** To secure ducting to the fan and vent cap.
4.  **HVAC-Grade Foil Tape:** For sealing all duct joints and connections. **Do not use standard duct tape (cloth-backed) as it degrades over time.**
5.  **Roof Cap or Wall Cap (Exterior Vent Hood):**
...
6.  **Insulation (for ductwork):** Required if the duct runs through an unconditioned attic space to prevent condensation inside the duct. The flexible insulated duct often comes pre-insulated. If using rigid ducting, wrap it with insulation (e.g., R-8 duct wrap).
7.  **Caulk/Roofing Sealant:** For sealing around the exterior vent cap.
8.  **Framing Materials (Optional):** If new fan mounting or additional attic bracing is needed.
