...
author: Isaac
layout: post
title: When to Trim Trees and Shrubs - Optimal Health and Blooms
categories:
  - Guides
  - Gardening
tags: []
...
**Q: Will pruning kill my tree or shrub?**
A: Proper pruning, even heavy pruning (like rejuvenation pruning), should not kill a healthy tree or shrub. However, removing too much live growth at once (more than 25-30% in a single season) or making improper cuts can stress the plant, weaken it, or lead to decline. Always know what you're cutting and why.
