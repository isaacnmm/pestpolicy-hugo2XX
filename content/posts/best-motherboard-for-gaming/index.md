...
Comes with a 2 gigabit Ethernet (Intel and Rivet networks killer). The Intel LAN is for productivity needs while the Rivet networks killer LAN comes with *QoS* software.

The *QoS* software helps to keep background tasks running for your gaming and assists in prioritizinggaming packets, which is excellent for first-time shooters.
