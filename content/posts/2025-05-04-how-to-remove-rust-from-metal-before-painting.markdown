...
- Prepare[the commercial rust remover](https://pestpolicy.com/rustoleum-rust-reformer-review/)according to the manufacturers instructions and apply gently
...
1. Always wear protective gear (boots, overall, respirator, facemask, gloves, and goggles) when removing rust from the metal surface for safety reasons.
