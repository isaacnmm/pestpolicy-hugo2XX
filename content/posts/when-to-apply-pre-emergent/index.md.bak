...
* **Cons: ** Can be slow to release from granular forms if not watered in adequately. * **Best Use: ** Excellent for general season-long control of crabgrass and other annual weeds in established lawns.
...
* **Pros: ** Effective on a broad range of weeds, offers some early post-emergent activity, relatively long residual. * **Cons: ** Post-emergent activity is limited to very young weeds. * **Best Use: ** A versatile choice for both early season prevention and those who might be slightly late with their application.

3. **Pendimethalin (e. g. , Scotts Turf Builder Halts Crabgrass Preventer, Pre-M): ** * **Characteristics: ** Effective against a wide variety of annual grassy and broadleaf weeds. It has a distinctive yellow color, which can sometimes be seen after application (though it typically washes into the soil). * **Pros: ** Broad-spectrum control, widely available. * **Cons: ** Can have a shorter residual than Prodiamine (typically 2-4 months).
...
4. **Isoxaben (e. g. , Gallery Specialty Herbicide): ** * **Characteristics: ** Primarily targets broadleaf weeds, offering excellent pre-emergent control for dandelions, clover, henbit, chickweed, and many others. It's often used in conjunction with a grassy weed pre-emergent or as a standalone for broadleaf prevention. * **Pros: ** Strong efficacy against broadleaf weeds. * **Cons: ** Does not control grassy weeds like crabgrass.
...
2. **Dithiopyr (e. g. , Dimension): ** * **Waiting Period: ** Generally **3-4 months**. Some formulations or lower application rates might allow for seeding sooner, but caution is advised. * **Reason: ** While also long-lasting, Dithiopyr tends to break down slightly faster than Prodiamine.
