...
* **Safety Gear:** Work boots, gloves, eye protection, ear protection (if using power equipment).
...
2.  **Cut and Fill (for Major Grading):**
    ...
    * **Pros:** Effective for significant changes in elevation, corrects serious drainage problems (e.g., negative grading), creates a truly level base for new construction or landscaping.
...
5.  **Installing Drainage Solutions (for Persistent Water Pooling):**
...
Choosing the right method (or combination of methods) requires a clear assessment of your yard's specific problems and your ultimate landscaping goals.
