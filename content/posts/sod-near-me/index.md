...
* **Thin Soil Layer: ** A small amount of the original topsoil (typically 0. 5 to 1 inch thick) remains attached to the roots, providing essential nutrients and a medium for quick establishment in its new home. * **Harvesting: ** Specialized machines cut the sod into uniform strips or rolls, making them easy to transport and lay. Common dimensions for rolls might be 2 feet by 5 feet, or larger, while slabs are often 16x24 inches.
...
* **Pros: ** * **Cost-Effective: ** Much cheaper than sod, especially for large areas. * **Wider Variety: ** A broader selection of grass species and blends available for specific conditions (sun, shade, traffic). * **Less Labor (Initial): ** Spreading seed is less physically demanding than laying heavy sod rolls.
...
* **Cons: ** * **Higher Cost: ** This is the primary drawback. Labor costs add significantly to the overall project expense. * **Less Control: ** You have to rely on the professional's schedule and methods, though good communication helps.
